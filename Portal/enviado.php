                                    ...
                                    <div class="p3">
                                        <form  id="contact-form" method="post" enctype="multipart/form-data">                    
                                            <fieldset>
																...
																$link = mysqli_connect("localhost", "alunos", "etec", "db_CookYourself");
																if($link === false){
																...
																$conteudo = mysqli_real_escape_string($link, $_POST['mensagem']);
																
																$sql = "INSERT INTO tbl_mensagens (mensagem_autor, mensagem_email, mensagem_conteudo) VALUES ('$nome', '$email', '$conteudo')";
																...
																if(mysqli_query($link, $sql)){
																	...
																	echo "Um erro ocorreu ao enviar a mensagem. Por favor, tente novamente mais tarde. " . mysqli_error($link);
